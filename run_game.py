...
CMD = [
    ...
    "-g", "standard",
    "-m", "hz_hazard_pits",
    "--name", "Heuristic", "--url", "http://127.0.0.1:8000",
    "--name", "MCTS random", "--url", "http://127.0.0.1:8001",
    "--name", "MCTS Heuristic", "--url", "http://127.0.0.1:8002",
    "--name", "MCTS progressive bias", "--url", "http://127.0.0.1:8003",
    "--foodSpawnChance", "25",
    "--minimumFood", "2",
    "--seed", "123",
    "--timeout", "1000",
